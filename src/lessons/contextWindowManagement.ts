...
async function run() {
  console.log('\n=== LESSON 05: proactive context compaction ===');

  const originalTaskText =
    'Read all files in the sandbox/05-context-compaction/ directory one by one and write a combined summary to sandbox/05-context-compaction/summary.txt.';
